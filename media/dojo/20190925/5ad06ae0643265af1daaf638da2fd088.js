...
conditions['treeskin'] = " $navtype.match(/tree|expand|accordion/) ";
conditions['themeskin'] = " $navtype.match(/drop|slide/) ";
conditions['back'] = " ($navtype.match(/drop|slide/) || $filter0 == 1) && $position0 != 'overlay' ";
conditions['modpos'] = " $position0 == 'module' ";
conditions['!modpos'] = " $position0 != 'module' ";
conditions['overlay'] = " $position0 == 'overlay' ";
conditions['!overlay'] = " $position0 != 'overlay' ";
conditions['popup'] = " $position0 == 'popup' ";
conditions['filter'] = " $filter0 == 1 && $position0 != 'overlay' ";
conditions['autoopen'] = " $autoopen0 > 0 ";
conditions['burger'] = " $position0 != 'module' || parseInt($position1) ";
conditions['burgertitle'] = " $burgertitle0 == 1 ";
conditions['burgertitle_small'] = " $burgertitle0 == 1 && $burgertitle4 == 'small' ";
conditions['!burgertitle_small'] = " $burgertitle0 == 1 && $burgertitle4 != 'small' ";
conditions['corner'] = " $openbutton == 'corner' ";
conditions['leftbutton'] = " $openbutton == 'corner' && $position0.match(/leftbar|popup|module/) ";
conditions['rightbutton'] = " $openbutton == 'corner' && $position0.match(/rightbar|overlay/) ";
conditions['sitebg'] = " ($position0 != 'module' || parseInt($position1)) && $position0 != 'popup' ";
conditions['sidebar'] = " ($position0 != 'module' || parseInt($position1)) && !$position0.match(/popup|overlay/) ";
conditions['maxheight'] = " $position0 == 'module' || $position0 == 'popup' ";
conditions['borderradius'] = " $position0 == 'module' || $position0 == 'popup' || $navtype == 'drop' ";
conditions['boxshadow'] = " $position0 == 'popup' || $navtype == 'drop' ";
conditions['desc'] = " $subheader0 == 1 && $position0 != 'overlay' ";
conditions['overlaydesc'] = " $subheader0 == 1 && $position0 == 'overlay' ";
conditions['displaynumprod'] = " $displaynumprod > 0 ";
conditions['menu_images'] = " $menu_images == 1 ";
conditions['advancedanim'] = " $advancedanim == 1 ";
conditions['advancedslide'] = " $advancedanim == 1 && $navtype != 'drop' ";
conditions['advanceddrop'] = " $advancedanim == 1 && $navtype == 'drop' ";
conditions['animatemenuitem'] = " $advancedanim == 1 && $animatemenuitem0 == 1 ";
conditions['!jquery'] = " !window.jQuery ";
conditions['improvedstartlevel'] = " $improvedstartlevel == 1 ";
conditions['!advancedvisibility'] = " $visibility4 != 1 ";
conditions['badge'] = " $badge == 1 ";
conditions['virtuemart'] = " $menutype == 'virtuemart2' ";
init_conditions();

      new OfflajnImportExport({
        id: "jformparamsmoduleparametersTab",
        modPath: "http://printervoronezh.ru/modules/mod_vertical_menu/",
        downloadName: "VerticalMenu_export_",
        exclude: "menutype joomlamenu joomlamenutype \\w+categoryid showproducts showcontents showitems zooapps zoocategories"
      });
    

      new OfflajnList({
        name: "jformparamsmoduleparametersTabmenutypemenutype",
        options: [{"value":"joomla","text":"Joomla"},{"value":"joomlacontent","text":"Joomlacontent"},{"value":"jshopping","text":"Jshopping"}],
        selectedIndex: 2,
        json: "",
        width: 0,
        height: 0,
        ...
        new TypeConfigurator({
          ...
          typeParams: {"default":"","joomla":"226776f356d7ecf58b60bab12a05d38f","joomlacontent":"e492dff2d76fc688714660cf6496096d","jshopping":"88acb507c9435e7339b97ee1e4bf885a"},
          typeScripts: {"default":""},
          joomfish: 0,
          control: "Type"
        });
      ...
      new OfflajnList({
        ...
        options: [{"value":"0","text":"No active elements"},{"value":"1","text":"Selected item active"},{"value":"2","text":"Selected branch active"}],
        selectedIndex: 2,
        json: "",
        width: 0,
        height: 0,
      ...
      new OfflajnToggle({
        ...
        src: "http://printervoronezh.ru/modules/mod_vertical_menu/params/images/mobile.png"
      });
    

      new OfflajnToggle({
        id: "jformparamsmoduleparametersTabvisibility1",
        src: "http://printervoronezh.ru/modules/mod_vertical_menu/params/images/tablet.png"
      });
    

      new OfflajnToggle({
        id: "jformparamsmoduleparametersTabvisibility2",
        src: "http://printervoronezh.ru/modules/mod_vertical_menu/params/images/desktop.png"
      });
    

      new OfflajnToggle({
        id: "jformparamsmoduleparametersTabvisibility3",
        src: "http://printervoronezh.ru/modules/mod_vertical_menu/params/images/wide-screen.png"
      });
      ...
      new OfflajnRadioimg({
        ...
        values: ["slide","drop","tree","expand","accordion"],
        map: {"slide":0,"drop":1,"tree":2,"expand":3,"accordion":4},
        mode: ""
      });
      ...
      new OfflajnRadioimg({
        ...
        values: ["module","popup","leftbar","rightbar","overlay"],
        map: {"module":0,"popup":1,"leftbar":2,"rightbar":3,"overlay":4},
        mode: ""
      });
...
dojo.addOnLoad(function(){ 
      ...
      new OfflajnList({
        ...
        options: [{"value":"mouseenter","text":"Hover"},{"value":"click","text":"Click"}],
        selectedIndex: 0,
        json: "",
        width: 0,
        height: 0,
      ...
      new OfflajnList({
        ...
        options: [{"value":"0","text":"Off"},{"value":"1","text":"Only once"},{"value":"2","text":"On every page load"}],
        selectedIndex: 0,
        json: "",
        width: 0,
        height: 0,
      ...
      new OfflajnRadio({
        ...
        new OfflajnImagemanager({
          ...
          imgs: ["54d1a9e19a0ab_thumb.jpg","Epson-L805.png","ava.png","beznal.png","joomla_black.png","payment.png","powered_by.png","pr.png","radio-1.png","radio-2.png","wait.gif"],
      ...
      new OfflajnList({
        ...
        options: [{"value":"","text":"[ No link ]"},{"value":"custom","text":"[ Custom ]"},{"value":"optgroup","text":"joomshopping"},{"value":"optgroup","text":"\u0413\u043b\u0430\u0432\u043d\u043e\u0435 \u043c\u0435\u043d\u044e"},{"value":"101","text":"&nbsp;&nbsp;&nbsp;\u00a0"},{"value":"134","text":"&nbsp;&nbsp;&nbsp;\u041e \u043a\u043e\u043c\u043f\u0430\u043d\u0438\u0438"},{"value":"136","text":"&nbsp;&nbsp;&nbsp;\u041e\u043f\u043b\u0430\u0442\u0430 \u0438 \u0434\u043e\u0441\u0442\u0430\u0432\u043a\u0430"},{"value":"170","text":"&nbsp;&nbsp;&nbsp;\u0423\u0441\u043b\u0443\u0433\u0438"},{"value":"171","text":"&nbsp;&nbsp;&nbsp;\u0417\u0430\u043f\u0440\u0430\u0432\u043a\u0430 \u043a\u0430\u0440\u0442\u0440\u0438\u0434\u0436\u0435\u0439 \u0432 \u041c\u043e\u0441\u043a\u0432\u0435"},{"value":"172","text":"&nbsp;&nbsp;&nbsp;\u0420\u0435\u043c\u043e\u043d\u0442 \u043f\u0440\u0438\u043d\u0442\u0435\u0440\u0430 HP"},{"value":"173","text":"&nbsp;&nbsp;&nbsp;\u0420\u0435\u043c\u043e\u043d\u0442 \u043f\u0440\u0438\u043d\u0442\u0435\u0440\u0430 Canon"},{"value":"174","text":"&nbsp;&nbsp;&nbsp;\u0420\u0435\u043c\u043e\u043d\u0442 \u043f\u0440\u0438\u043d\u0442\u0435\u0440\u0430 Epson"},{"value":"175","text":"&nbsp;&nbsp;&nbsp;\u0420\u0435\u043c\u043e\u043d\u0442 \u043f\u0440\u0438\u043d\u0442\u0435\u0440\u0430 Kyocera"},{"value":"176","text":"&nbsp;&nbsp;&nbsp;\u0420\u0435\u043c\u043e\u043d\u0442 \u043f\u0440\u0438\u043d\u0442\u0435\u0440\u0430 Lexmark"},{"value":"177","text":"&nbsp;&nbsp;&nbsp;\u0420\u0435\u043c\u043e\u043d\u0442 \u043f\u0440\u0438\u043d\u0442\u0435\u0440\u0430 Brother"},{"value":"178","text":"&nbsp;&nbsp;&nbsp;\u0420\u0435\u043c\u043e\u043d\u0442 \u043f\u0440\u0438\u043d\u0442\u0435\u0440\u0430 Ricoh"},{"value":"138","text":"&nbsp;&nbsp;&nbsp;\u041a\u043e\u043d\u0442\u0430\u043a\u0442\u044b "},{"value":"188","text":"&nbsp;&nbsp;&nbsp;\u0412\u0445\u043e\u0434\u00a0 "},{"value":"144","text":"&nbsp;&nbsp;&nbsp;\u0412\u0445\u043e\u0434"},{"value":"137","text":"&nbsp;&nbsp;&nbsp;\u041a\u0430\u0440\u0442\u0430 \u0441\u0430\u0439\u0442\u0430"},{"value":"optgroup","text":"\u041c\u0430\u0433\u0430\u0437\u0438\u043d"},{"value":"optgroup","text":"\u041f\u043e\u043b\u0435\u0437\u043d\u043e\u0435"},{"value":"135","text":"&nbsp;&nbsp;&nbsp;\u041d\u043e\u0432\u043e\u0441\u0442\u0438"},{"value":"139","text":"&nbsp;&nbsp;&nbsp;\u0420\u0430\u0431\u043e\u0442\u0430\u0435\u043c \u0441 \u0440\u0435\u0433\u0438\u043e\u043d\u0430\u043c\u0438"},{"value":"140","text":"&nbsp;&nbsp;&nbsp;\u0421\u043a\u0430\u0447\u0430\u0442\u044c \u0434\u0440\u0430\u0439\u0432\u0435\u0440\u0430"},{"value":"162","text":"&nbsp;&nbsp;&nbsp;\u0414\u0440\u0430\u0439\u0432\u0435\u0440\u044b HP"},{"value":"163","text":"&nbsp;&nbsp;&nbsp;\u0414\u0440\u0430\u0439\u0432\u0435\u0440\u044b Brother"},{"value":"164","text":"&nbsp;&nbsp;&nbsp;\u0414\u0440\u0430\u0439\u0432\u0435\u0440\u044b Samsung"},{"value":"160","text":"&nbsp;&nbsp;&nbsp;\u0414\u0440\u0430\u0439\u0432\u0435\u0440\u044b Epson"},{"value":"161","text":"&nbsp;&nbsp;&nbsp;\u0414\u0440\u0430\u0439\u0432\u0435\u0440\u044b Canon"},{"value":"165","text":"&nbsp;&nbsp;&nbsp;\u0414\u0440\u0430\u0439\u0432\u0435\u0440 \u0434\u043b\u044f Xerox"},{"value":"166","text":"&nbsp;&nbsp;&nbsp;\u0414\u0440\u0430\u0439\u0432\u0435\u0440 \u0434\u043b\u044f Lexmark"},{"value":"167","text":"&nbsp;&nbsp;&nbsp;\u0414\u0440\u0430\u0439\u0432\u0435\u0440 \u0434\u043b\u044f Kyocera"},{"value":"optgroup","text":"\u0421\u043a\u0440\u044b\u0442\u043e\u0435 \u043c\u0435\u043d\u044e"},{"value":"141","text":"&nbsp;&nbsp;&nbsp;\u041a\u043e\u0440\u0437\u0438\u043d\u0430"},{"value":"142","text":"&nbsp;&nbsp;&nbsp;\u041e\u0444\u043e\u0440\u043c\u043b\u0435\u043d\u0438\u0435 \u0437\u0430\u043a\u0430\u0437\u0430"},{"value":"143","text":"&nbsp;&nbsp;&nbsp;\u041f\u0440\u043e\u0444\u0438\u043b\u044c"},{"value":"145","text":"&nbsp;&nbsp;&nbsp;\u0420\u0435\u0433\u0438\u0441\u0442\u0440\u0430\u0446\u0438\u044f"},{"value":"168","text":"&nbsp;&nbsp;&nbsp;\u0414\u043e\u0433\u043e\u0432\u043e\u0440-\u043e\u0444\u0435\u0440\u0442\u0430"},{"value":"169","text":"&nbsp;&nbsp;&nbsp;\u0412\u043e\u0441\u0441\u0442\u0430\u043d\u043e\u0432\u043b\u0435\u043d\u0438\u0435 \u043f\u0430\u0440\u043e\u043b\u044f"}],
        selectedIndex: 0,
        json: "",
        width: 0,
        height: 10,
      ...
      new OfflajnList({
        ...
        options: [{"value":"clean","text":"Clean"},{"value":"flat","text":"Flat"},{"value":"rounded","text":"Rounded"}],
        selectedIndex: 0,
        json: "",
        width: 0,
        height: 0,
      ...
      var theme = new ThemeConfigurator({
        ...
        themeSelector: null,
        themeParams: {"default":"","clean":"123402c04dcfb6625f688f771a5fc05d","flat":"37fc7edee25a177474eaebe7f7b09785","rounded":"990fcd0ba3c5c9e322c930c83a93be48"},
      ...
      new OfflajnList({
        ...
        options: [{"value":"-1","text":"Reduce width"},{"value":"1","text":"Slide in on top"},{"value":"2","text":"Reveal"},{"value":"3","text":"Push"},{"value":"4","text":"Slide along"},{"value":"5","text":"Reverse slide out"},{"value":"6","text":"Rotate pusher"},{"value":"7","text":"3D rotate in"},{"value":"8","text":"3D rotate out"},{"value":"9","text":"Scale down pusher"},{"value":"10","text":"Scale Up"},{"value":"11","text":"Scale & rotate pusher"},{"value":"12","text":"Open door"},{"value":"13","text":"Fall down"},{"value":"14","text":"Delayed 3D Rotate"}],
        selectedIndex: 1,
        json: "",
        width: 0,
        height: 10,
      ...
      new OfflajnList({
        ...
        options: [{"value":"1","text":"Slide down"},{"value":"2","text":"Scale"},{"value":"3","text":"Genie"},{"value":"4","text":"Content scale"},{"value":"5","text":"Rotate screen"},{"value":"6","text":"Flip top"},{"value":"7","text":"Flip left"},{"value":"9","text":"Flip on Y"},{"value":"10","text":"Flip on X"},{"value":"11","text":"Zoom"},{"value":"12","text":"Flip bottom"},{"value":"13","text":"Scale & slide right"},{"value":"14","text":"Fade"}],
        selectedIndex: 0,
        json: "",
        width: 0,
        height: 10,
      ...
      new OfflajnList({
        ...
        options: [{"value":"0","text":"None"},{"value":"1","text":"Square brackets"},{"value":"2","text":"Underline 1"},{"value":"3","text":"Underline 2"},{"value":"4","text":"Swipe up"},{"value":"5","text":"Push down"},{"value":"6","text":"Fill out"}],
        selectedIndex: 1,
        json: "",
        width: 0,
        height: 0,
      ...
      new OfflajnList({
        ...
        options: [{"value":"custom","text":"Custom"},{"value":"default_slide","text":"Slide"},{"value":"default_parallax","text":"Parallax"},{"value":"default_cube","text":"Cube"},{"value":"default_push","text":"Push"},{"value":"default_flip","text":"Flip"},{"value":"default_flipflop","text":"Flipflop"},{"value":"default_zoom","text":"Zoom"}],
        selectedIndex: 0,
        json: "",
        width: 0,
        height: 0,
      ...
      window.menupreset = new OfflajnSkin({
        ...
        data: {"default_slide":{"perspective":"0||px","transition_in":"Quad.easeOut|*|50% 50% 0|*|100|*|%|*|0|*|100||%|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|100||%|*|100||%","transition_out":"Quad.easeOut|*|50% 50% 0|*|-100|*|%|*|0|*|100||%|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|100||%|*|100||%"},"default_parallax":{"perspective":"0||px","transition_in":"Quad.easeOut|*|50% 50% 0|*|100|*|%|*|0|*|100||%|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|100||%|*|100||%","transition_out":"Quad.easeOut|*|50% 50% 0|*|-33|*|%|*|0|*|95||%|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|100||%|*|100||%"},"default_cube":{"perspective":"1000||px","transition_in":"Quad.easeOut|*|50% 50% -50%|*|0|*|px|*|0|*|100||%|*|0||\u00b0|*|90||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|100||%|*|100||%","transition_out":"Quad.easeOut|*|50% 50% -50%|*|0|*|px|*|0|*|100||%|*|0||\u00b0|*|-90||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|100||%|*|100||%"},"default_push":{"perspective":"500||px","transition_in":"Cubic.easeOut|*|0% 50% 0|*|100|*|%|*|0|*|100||%|*|0||\u00b0|*|-90||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|100||%|*|100||%","transition_out":"Quad.easeOut|*|50% 50% 0|*|0|*|%|*|0|*|85||%|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|80||%|*|80||%"},"default_flip":{"perspective":"1000||px","transition_in":"Circ.easeOut|*|50% 50% 0|*|100|*|%|*|0|*|100||%|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|100||%|*|100||%","transition_out":"Quad.easeOut|*|-20% 50% 0|*|-5|*|%|*|0|*|95||%|*|0||\u00b0|*|90||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|100||%|*|100||%"},"default_flipflop":{"perspective":"1500||px","transition_in":"Quad.easeOut|*|120% 50% 0|*|100|*|%|*|0|*|95||%|*|0||\u00b0|*|-90||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|100||%|*|100||%","transition_out":"Quad.easeOut|*|-20% 50% 0|*|-5|*|%|*|0|*|95||%|*|0||\u00b0|*|90||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|100||%|*|100||%"},"default_zoom":{"perspective":"0||px","transition_in":"Quad.easeOut|*|50% 50% 0|*|100|*|%|*|0|*|100||%|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|100||%|*|100||%","transition_out":"Quad.easeOut|*|50% 50% 0|*|0|*|%|*|0|*|0||%|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|125||%|*|125||%"}},
      ...
      new OfflajnList({
        ...
        options: [{"value":"custom","text":"Custom"},{"value":"default_slide_through","text":"Slide through"},{"value":"default_slide_in","text":"Slide in"},{"value":"default_fly_in","text":"Fly in"},{"value":"default_fly_up","text":"Fly up"},{"value":"default_turndown","text":"Turndown"},{"value":"default_flip_3d","text":"Flip 3d"},{"value":"default_rotate","text":"Rotate"},{"value":"default_bounce_rotate","text":"Bounce rotate"},{"value":"default_newspaper","text":"Newspaper"},{"value":"default_elastic","text":"Elastic"},{"value":"default_skew","text":"Skew"},{"value":"default_scale_down","text":"Scale down"},{"value":"default_flexible_flip","text":"Flexible flip"},{"value":"default_flexible_flip_up","text":"Flexible flip up"},{"value":"default_flexible","text":"Flexible"}],
        selectedIndex: 0,
        json: "",
        width: 0,
        height: 10,
      ...
      window.droppreset = new OfflajnSkin({
        ...
        data: {"default_slide_through":{"dropdur":"300||ms|*|200||ms|*|","drop_in":"Quad.easeOut|*|50% 50% 0|*|-30|*|px|*|0||px|*|0||%|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|100||%|*|100||%|*|","drop_out":"Quad.easeOut|*|50% 50% 0|*|20|*|px|*|0||px|*|0||%|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|100||%|*|100||%|*|"},"default_slide_in":{"dropdur":"300||ms|*|200||ms|*|","drop_in":"Quad.easeOut|*|50% 50% 0|*|30|*|px|*|0||px|*|0||%|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|100||%|*|100||%|*|","drop_out":"Quad.easeOut|*|50% 50% 0|*|20|*|px|*|0||px|*|0||%|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|100||%|*|100||%|*|"},"default_fly_in":{"dropdur":"600||ms|*|300||ms|*|","drop_in":"Back.easeOut|*|0% 50% 0|*|80|*|px|*|0|*|0||%|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|100||%|*|100||%|*|","drop_out":"Quad.easeOut|*|0% 50% 0|*|40|*|px|*|0|*|0||%|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|100||%|*|100||%|*|"},"default_fly_up":{"dropdur":"600||ms|*|300||ms|*|","drop_in":"Back.easeOut|*|0% 50% 0|*|0|*|px|*|80||px|*|0||%|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|100||%|*|100||%|*|","drop_out":"Quad.easeOut|*|0% 50% 0|*|0|*|px|*|40||px|*|0||%|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|100||%|*|100||%|*|"},"default_turndown":{"dropdur":"600||ms|*|500||ms|*|","drop_in":"Expo.easeOut|*|10% 50% -100px|*|0|*|px|*|0||px|*|0||%|*|90||\u00b0|*|0||\u00b0|*|0||\u00b0|*|10||\u00b0|*|0||\u00b0|*|100||%|*|100||%|*|","drop_out":"Quad.easeOut|*|10% 50% -100px|*|0|*|px|*|0||px|*|0||%|*|-90||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|100||%|*|100||%|*|"},"default_flip_3d":{"dropdur":"600||ms|*|500||ms|*|","droppersp":"1000||px","drop_in":"Expo.easeOut|*|50% 50% -100px|*|-20|*|px|*|0||px|*|0||%|*|0||\u00b0|*|90||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|100||%|*|100||%|*|","drop_out":"Quad.easeOut|*|50% 50% -100px|*|-20|*|px|*|0||px|*|0||%|*|0||\u00b0|*|90||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|100||%|*|100||%|*|"},"default_rotate":{"droppersp":"1000||px","dropdur":"300||ms|*|300||ms|*|","drop_in":"Quad.easeOut|*|0% 50% 0|*|0|*|px|*|0|*|0||%|*|0||\u00b0|*|90||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|100||%|*|100||%","drop_out":"Quad.easeOut|*|0% 50% 0|*|0|*|px|*|0|*|0||%|*|0||\u00b0|*|90||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|100||%|*|100||%"},"default_bounce_rotate":{"dropdur":"900||ms|*|300||ms|*|","droppersp":"1000||px","drop_in":"Bounce.easeOut|*|50% 50% -100px|*|0|*|px|*|-50||px|*|200||%|*|80||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|100||%|*|100||%|*|","drop_out":"Quad.easeOut|*|50% 50% -100px|*|0|*|px|*|50||px|*|0||%|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|100||%|*|100||%|*|"},"default_newspaper":{"dropdur":"600||ms|*|300||ms|*|","droppersp":"1000||px","drop_in":"Expo.easeOut|*|50% 50% -100px|*|-20|*|px|*|0||px|*|0||%|*|180||\u00b0|*|90||\u00b0|*|270||\u00b0|*|0||\u00b0|*|0||\u00b0|*|100||%|*|100||%|*|","drop_out":"Quad.easeOut|*|50% 50% -100px|*|50|*|px|*|0||px|*|0||%|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|100||%|*|100||%|*|"},"default_elastic":{"dropdur":"1500||ms|*|200||ms|*|","droppersp":"1000||px","drop_in":"Elastic.easeOut|*|0% 20px 0|*|-20|*|px|*|0||px|*|0||%|*|0||\u00b0|*|0||\u00b0|*|60||\u00b0|*|0||\u00b0|*|0||\u00b0|*|40||%|*|40||%|*|","drop_out":"Quad.easeOut|*|50% 50% 0|*|20|*|px|*|0||px|*|0||%|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|100||%|*|100||%|*|"},"default_skew":{"dropdur":"600||ms|*|300||ms|*|","droppersp":"1000||px","drop_in":"Expo.easeOut|*|50% 50% 0|*|100|*|px|*|0||px|*|0||%|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|30||\u00b0|*|0||\u00b0|*|100||%|*|100||%|*|","drop_out":"Quad.easeOut|*|50% 50% -100px|*|50|*|px|*|0||px|*|0||%|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|100||%|*|100||%|*|"},"default_scale_down":{"dropdur":"600||ms|*|200||ms|*|","droppersp":"1000||px","drop_in":"Expo.easeOut|*|0% 20px 0|*|40|*|px|*|0||px|*|0||%|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|150||%|*|150||%|*|","drop_out":"Quad.easeOut|*|0 20px 0|*|0|*|px|*|0||px|*|0||%|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|50||%|*|50||%|*|"},"default_flexible_flip":{"dropdur":"600||ms|*|300||ms|*|","droppersp":"1000||px","drop_in":"Back.easeOut|*|50% 50% -100px|*|-50|*|px|*|0||px|*|0||%|*|0||\u00b0|*|-90||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|100||%|*|100||%|*|","drop_out":"Quad.easeOut|*|50% 50% -100px|*|50|*|px|*|0||px|*|0||%|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|100||%|*|100||%|*|"},"default_flexible_flip_up":{"dropdur":"600||ms|*|300||ms|*|","droppersp":"1000||px","drop_in":"Back.easeOut|*|50% 50% -100px|*|0|*|px|*|-50||px|*|0||%|*|-90||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|100||%|*|100||%|*|","drop_out":"Quad.easeOut|*|50% 50% -100px|*|50|*|px|*|0||px|*|0||%|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|100||%|*|100||%|*|"},"default_flexible":{"dropdur":"600||ms|*|300||ms|*|","droppersp":"1000||px","drop_in":"Back.easeOut|*|50% 50% 0|*|-50|*|px|*|0||px|*|0||%|*|0||\u00b0|*|90||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|100||%|*|100||%|*|","drop_out":"Quad.easeOut|*|50% 50% -100px|*|50|*|px|*|0||px|*|0||%|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|100||%|*|100||%|*|"}},
        root: 'http://printervoronezh.ru/',
        control: "jform[params][animationTab]",
        dependency: ''
      });
      ...
      new OfflajnList({
        ...
        options: [{"value":"Linear.easeNone","text":"Linear"},{"value":"Back.easeOut","text":"Back easeOut"},{"value":"Back.easeIn","text":"Back easeIn"},{"value":"Back.easeInOut","text":"Back easeInOut"},{"value":"Bounce.easeOut","text":"Bounce easeOut"},{"value":"Bounce.easeIn","text":"Bounce easeIn"},{"value":"Bounce.easeInOut","text":"Bounce easeInOut"},{"value":"Circ.easeOut","text":"Circ easeOut"},{"value":"Circ.easeIn","text":"Circ easeIn"},{"value":"Circ.easeInOut","text":"Circ easeInOut"},{"value":"Cubic.easeOut","text":"Cubic easeOut"},{"value":"Cubic.easeIn","text":"Cubic easeIn"},{"value":"Cubic.easeInOut","text":"Cubic easeInOut"},{"value":"Elastic.easeOut","text":"Elastic easeOut"},{"value":"Elastic.easeIn","text":"Elastic easeIn"},{"value":"Elastic.easeInOut","text":"Elastic easeInOut"},{"value":"Expo.easeOut","text":"Expo easeOut"},{"value":"Expo.easeIn","text":"Expo easeIn"},{"value":"Expo.easeInOut","text":"Expo easeInOut"},{"value":"Quad.easeOut","text":"Quad easeOut"},{"value":"Quad.easeIn","text":"Quad easeIn"},{"value":"Quad.easeInOut","text":"Quad easeInOut"},{"value":"Quart.easeOut","text":"Quart easeOut"},{"value":"Quart.easeIn","text":"Quart easeIn"},{"value":"Quart.easeInOut","text":"Quart easeInOut"},{"value":"Quint.easeOut","text":"Quint easeOut"},{"value":"Quint.easeIn","text":"Quint easeIn"},{"value":"Quint.easeInOut","text":"Quint easeInOut"},{"value":"Sine.easeOut","text":"Sine easeOut"},{"value":"Sine.easeIn","text":"Sine easeIn"},{"value":"Sine.easeInOut","text":"Sine easeInOut"}],
        selectedIndex: 19,
        json: "",
        width: 0,
        height: 10,
...
dojo.addOnLoad(function(){ 
      ...
      new OfflajnList({
        ...
        options: [{"value":"custom","text":"Custom"},{"value":"default_slide","text":"Slide"},{"value":"default_scale_x","text":"Scale x"},{"value":"default_slide_and_rotate","text":"Slide and rotate"},{"value":"default_flexible_slide","text":"Flexible slide"},{"value":"default_slide_up","text":"Slide up"},{"value":"default_rotate_in","text":"Rotate in"},{"value":"default_rotate_down","text":"Rotate down"},{"value":"default_scale","text":"Scale"},{"value":"default_flip_up","text":"Flip up"},{"value":"default_scale_up","text":"Scale up"},{"value":"default_scale_down","text":"Scale down"},{"value":"default_flip_right","text":"Flip right"},{"value":"default_open_up","text":"Open up"}],
        selectedIndex: 0,
        json: "",
        width: 0,
        height: 10,
      ...
      window.menuitempreset = new OfflajnSkin({
        ...
        data: {"default_slide":{"animatemenuitem":"1|*|250||ms|*|100||ms|*|","menuitemtrans":"Quad.easeOut|*|50% 50% 0|*|15|*|%|*|0||px|*|0||%|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|100||%|*|100||%|*|"},"default_scale_x":{"animatemenuitem":"1|*|300||ms|*|100||ms|*|","menuitemtrans":"Quad.easeOut|*|50% 50% 0|*|0|*|%|*|0||px|*|0||%|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|200||%|*|100||%|*|"},"default_slide_and_rotate":{"animatemenuitem":"1|*|400||ms|*|100||ms|*|","menuitemtrans":"Quad.easeOut|*|50% 50% 0|*|-35|*|%|*|0||px|*|0||%|*|0||\u00b0|*|90||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|100||%|*|100||%|*|"},"default_flexible_slide":{"animatemenuitem":"1|*|500||ms|*|100||ms|*|","menuitemtrans":"Back.easeOut|*|0% 50% 0|*|5|*|%|*|0||px|*|0||%|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|250||%|*|30||%|*|"},"default_slide_up":{"animatemenuitem":"1|*|300||ms|*|80||ms|*|","menuitemtrans":"Quad.easeOut|*|50% 50% 0|*|0|*|%|*|40||px|*|0||%|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|90||%|*|90||%|*|"},"default_rotate_in":{"animatemenuitem":"1|*|400||ms|*|50||ms|*|","menuitemtrans":"Expo.easeOut|*|0% 0% 0|*|-20|*|%|*|0||px|*|0||%|*|0||\u00b0|*|0||\u00b0|*|80||\u00b0|*|0||\u00b0|*|0||\u00b0|*|100||%|*|100||%|*|"},"default_rotate_down":{"animatemenuitem":"1|*|500||ms|*|50||ms|*|","menuitemtrans":"Expo.easeOut|*|50% -200% 0|*|-10|*|%|*|20||px|*|0||%|*|0||\u00b0|*|0||\u00b0|*|-60||\u00b0|*|0||\u00b0|*|0||\u00b0|*|20||%|*|20||%|*|"},"default_scale":{"animatemenuitem":"1|*|400||ms|*|50||ms|*|","menuitemtrans":"Quad.easeOut|*|50% -200% 0|*|0|*|%|*|0||px|*|0||%|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||%|*|0||%|*|"},"default_flip_up":{"animatemenuitem":"1|*|400||ms|*|0||ms|*|","menuitemtrans":"Quad.easeOut|*|50% 50% 0|*|0|*|%|*|50||px|*|100||%|*|90||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|100||%|*|100||%|*|"},"default_scale_up":{"animatemenuitem":"1|*|400||ms|*|0||ms|*|","menuitemtrans":"Quad.easeOut|*|50% -20% 0|*|0|*|%|*|0||px|*|0||%|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||%|*|0||%|*|"},"default_scale_down":{"animatemenuitem":"1|*|400||ms|*|0||ms|*|","menuitemtrans":"Quad.easeOut|*|50% 50% 0|*|0|*|%|*|50||px|*|100||%|*|90||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|150||%|*|150||%|*|"},"default_flip_right":{"animatemenuitem":"1|*|400||ms|*|0||ms|*|","menuitemtrans":"Quad.easeOut|*|0% 50% 0|*|0|*|%|*|0||px|*|100||%|*|0||\u00b0|*|90||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|100||%|*|100||%|*|"},"default_open_up":{"animatemenuitem":"1|*|400||ms|*|0||ms|*|","menuitemtrans":"Quad.easeOut|*|50% 0% 0|*|0|*|%|*|0||px|*|0||%|*|-160||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|0||\u00b0|*|100||%|*|100||%|*|"}},
        root: 'http://printervoronezh.ru/',
        control: "jform[params][animationTab]",
        dependency: ''
      });
