    ...
    <div  class="width-60 jdfltlft">
        ...
        <fieldset class="panelform">
            ...
            <!-- If we will use a checkbox field only as 'readonly', we must use the hidden value="1" for it --> 
                ...
                <li><input type="hidden" name="jform[form_created_id]" value="0">
                <?php echo $this->form->getLabel('form_created_id'); ?>
                <?php echo $this->form->getInput('form_created_id'); ?> 
                <!--<input type="hidden" name="jform[form_created_id_x]" value="0">
                <?php // echo $this->form->getInput('form_created_id_x'); ?>--></li>                
