...
/**
    ...
    public function checkData($isNew, $auto_added = false)
    {
        ...
        if ($table->load(array('file_alias' => $this->file_alias, 'cat_id' => $this->cat_id)) && ($table->file_id != $this->file_id || $this->file_id == 0)) {
            if ($auto_added){
                $this->file_alias .= mt_rand(100,999);    
            } else {
        ...
        if (!$auto_added){
            ...
            */          
            $file = ArrayHelper::getValue($_FILES,'picnew',array('tmp_name'=>'')); 
