...
switch($_REQUEST['method']) {
   ...
   if(!empty($_POST['metaid'])) {
      ...
      $updater = updater($metaid, $metatitle, $metadescription, $metakeywords);

      if(empty($updater)) {
         jsonResponse(200,"Items Not Found", NULL);
      } else {
         jsonResponse(200,"Item Found", $updater);
      }
}
...
break;	
   ...
   if(!empty($_POST['imgid'])) {
      ...
      $updateimg = updateimg($imgid, $imgname);

      if(empty($updateimg)) {
         jsonResponse(200,"Img name updated", NULL);
      } else {
...
break;	
   ...
   if(!empty($_POST['category_id'])) {
      ...
      if(empty($set_category)) {
         ...
         jsonResponse(200,"Item Found", $set_category);
      }
}
...
break;	
   ...
   if(!empty($_POST['img_image_id'])) {
      ...
      if(empty($set_product_img)) {
         ...
         jsonResponse(200,"Item Found", $set_product_img);
      }
}
...
break;	
   ...
   if(!empty($_POST['category_product_id'])) {
      ...
      if(empty($set_product)) {
         ...
         jsonResponse(200,"Item Found",$set_product);
      }
}
...
function updater($metaid1, $metatitle1, $metadescription1, $metakeywords1) {
...
$updateimgsql = "UPDATE s1y5k_jshopping_products_images SET `name`=:imgname WHERE image_id=:imgid";
   ...
   function set_category($category_category_id1, $category_category_image1, $category_category_parent_id1,
