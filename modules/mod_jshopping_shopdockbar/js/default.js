...
jQuery.easing.jswing=jQuery.easing.swing,jQuery.extend(jQuery.easing,{def:"easeOutQuad",swing:function(a,b,c,d,e){return jQuery.easing[jQuery.easing.def](a,b,c,d,e)},easeInQuad:function(a,b,c,d,e){return d*(b/=e)*b+c},easeOutQuad:function(a,b,c,d,e){return-d*(b/=e)*(b-2)+c},easeInOutQuad:function(a,b,c,d,e){return(b/=e/2)<1?d/2*b*b+c:-d/2*(--b*(b-2)-1)+c},easeInCubic:function(a,b,c,d,e){return d*(b/=e)*b*b+c},easeOutCubic:function(a,b,c,d,e){return d*((b=b/e-1)*b*b+1)+c},easeInOutCubic:function(a,b,c,d,e){return(b/=e/2)<1?d/2*b*b*b+c:d/2*((b-=2)*b*b+2)+c},easeInQuart:function(a,b,c,d,e){return d*(b/=e)*b*b*b+c},easeOutQuart:function(a,b,c,d,e){return-d*((b=b/e-1)*b*b*b-1)+c},easeInOutQuart:function(a,b,c,d,e){return(b/=e/2)<1?d/2*b*b*b*b+c:-d/2*((b-=2)*b*b*b-2)+c},easeInQuint:function(a,b,c,d,e){return d*(b/=e)*b*b*b*b+c},easeOutQuint:function(a,b,c,d,e){return d*((b=b/e-1)*b*b*b*b+1)+c},easeInOutQuint:function(a,b,c,d,e){return(b/=e/2)<1?d/2*b*b*b*b*b+c:d/2*((b-=2)*b*b*b*b+2)+c},easeInSine:function(a,b,c,d,e){return-d*Math.cos(b/e*(Math.PI/2))+d+c},easeOutSine:function(a,b,c,d,e){return d*Math.sin(b/e*(Math.PI/2))+c},easeInOutSine:function(a,b,c,d,e){return-d/2*(Math.cos(Math.PI*b/e)-1)+c},easeInExpo:function(a,b,c,d,e){return b==0?c:d*Math.pow(2,10*(b/e-1))+c},easeOutExpo:function(a,b,c,d,e){return b==e?c+d:d*(-Math.pow(2,-10*b/e)+1)+c},easeInOutExpo:function(a,b,c,d,e){return b==0?c:b==e?c+d:(b/=e/2)<1?d/2*Math.pow(2,10*(b-1))+c:d/2*(-Math.pow(2,-10*--b)+2)+c},easeInCirc:function(a,b,c,d,e){return-d*(Math.sqrt(1-(b/=e)*b)-1)+c},easeOutCirc:function(a,b,c,d,e){return d*Math.sqrt(1-(b=b/e-1)*b)+c},easeInOutCirc:function(a,b,c,d,e){return(b/=e/2)<1?-d/2*(Math.sqrt(1-b*b)-1)+c:d/2*(Math.sqrt(1-(b-=2)*b)+1)+c},easeInElastic:function(a,b,c,d,e){var f=1.70158,g=0,h=d;if(b==0)return c;if((b/=e)==1)return c+d;g||(g=e*.3);if(h<Math.abs(d)){h=d;var f=g/4}else var f=g/(2*Math.PI)*Math.asin(d/h);return-(h*Math.pow(2,10*(b-=1))*Math.sin((b*e-f)*2*Math.PI/g))+c},easeOutElastic:function(a,b,c,d,e){var f=1.70158,g=0,h=d;if(b==0)return c;if((b/=e)==1)return c+d;g||(g=e*.3);if(h<Math.abs(d)){h=d;var f=g/4}else var f=g/(2*Math.PI)*Math.asin(d/h);return h*Math.pow(2,-10*b)*Math.sin((b*e-f)*2*Math.PI/g)+d+c},easeInOutElastic:function(a,b,c,d,e){var f=1.70158,g=0,h=d;if(b==0)return c;if((b/=e/2)==2)return c+d;g||(g=e*.3*1.5);if(h<Math.abs(d)){h=d;var f=g/4}else var f=g/(2*Math.PI)*Math.asin(d/h);return b<1?-0.5*h*Math.pow(2,10*(b-=1))*Math.sin((b*e-f)*2*Math.PI/g)+c:h*Math.pow(2,-10*(b-=1))*Math.sin((b*e-f)*2*Math.PI/g)*.5+d+c},easeInBack:function(a,b,c,d,e,f){return f==undefined&&(f=1.70158),d*(b/=e)*b*((f+1)*b-f)+c},easeOutBack:function(a,b,c,d,e,f){return f==undefined&&(f=1.70158),d*((b=b/e-1)*b*((f+1)*b+f)+1)+c},easeInOutBack:function(a,b,c,d,e,f){return f==undefined&&(f=1.70158),(b/=e/2)<1?d/2*b*b*(((f*=1.525)+1)*b-f)+c:d/2*((b-=2)*b*(((f*=1.525)+1)*b+f)+2)+c},easeInBounce:function(a,b,c,d,e){return d-jQuery.easing.easeOutBounce(a,e-b,0,d,e)+c},easeOutBounce:function(a,b,c,d,e){return(b/=e)<1/2.75?d*7.5625*b*b+c:b<2/2.75?d*(7.5625*(b-=1.5/2.75)*b+.75)+c:b<2.5/2.75?d*(7.5625*(b-=2.25/2.75)*b+.9375)+c:d*(7.5625*(b-=2.625/2.75)*b+.984375)+c},easeInOutBounce:function(a,b,c,d,e){return b<e/2?jQuery.easing.easeInBounce(a,b*2,0,d,e)*.5+c:jQuery.easing.easeOutBounce(a,b*2-e,0,d,e)*.5+d*.5+c}});
 ...
 jQuery(document).ready(function(){
              ...
              if(jQuery("div").is(".attributes_10")){
             ...
             mas[jQuery("#i"+jQuery("#jshop_attr_id10 option:selected").val()+"").attr("value1")]=jQuery("#i"+jQuery("#jshop_attr_id10 option:selected").val()+"").attr("value2");
             jQuery("input[name='freeattribut[2]']").parent("span").parent("div").css("display", "none");
             jQuery("input[name='freeattribut[3]']").parent("span").parent("div").css("display", "none");
             jQuery("input[name='freeattribut[3]']").val("");jQuery("input[name='freeattribut[2]']").val("");  
              var cnt=11;   
             // alert(jQuery("#jshop_attr_id10 :selected").val());
              
               if( mas[jQuery("#i"+jQuery("#jshop_attr_id10 option:selected").val()+"").attr("value1")]=="[C]"){
                  cnt=11;
                  jQuery("input[name='freeattribut[2]']").parent("span").parent("div").css("display", "block");
                  jQuery("input[name='freeattribut[3]']").parent("span").parent("div").css("display", "none");  
                  jQuery("input[name='freeattribut[3]']").val("");
                }
                if( mas[jQuery("#i"+jQuery("#jshop_attr_id10 option:selected").val()+"").attr("value1")]=="[S]"){
                    
                  cnt=15;
                  jQuery("input[name='freeattribut[3]']").parent("span").parent("div").css("display", "block");
                  jQuery("input[name='freeattribut[2]']").parent("span").parent("div").css("display", "none");
                  jQuery("input[name='freeattribut[2]']").val("");  
                }
                if( mas[jQuery("#i"+jQuery("#jshop_attr_id10 option:selected").val()+"").attr("value1")]=="[S10]"){
                  cnt=10;
                  jQuery("input[name='freeattribut[3]']").parent("span").parent("div").css("display", "block");
                  jQuery("input[name='freeattribut[2]']").parent("span").parent("div").css("display", "none");
                  jQuery("input[name='freeattribut[2]']").val("");  
                }
                if( mas[jQuery("#i"+jQuery("#jshop_attr_id10 option:selected").val()+"").attr("value1")]=="[S10 C]"){
                   cnt=-1;
                   jQuery("input[name='freeattribut[3]']").parent("span").parent("div").css("display", "block");
                   jQuery("input[name='freeattribut[2]']").parent("span").parent("div").css("display", "block");
                }
                if( mas[jQuery("#i"+jQuery("#jshop_attr_id10 option:selected").val()+"").attr("value1")]=="[SC]"){
             ...
             jQuery("#jshop_attr_id10").change(function(){
                mas[jQuery("#i"+jQuery("#jshop_attr_id10 option:selected").val()+"").attr("value1")]=jQuery("#i"+jQuery("#jshop_attr_id10 option:selected").val()+"").attr("value2");
             ...
             jQuery("input[name='freeattribut[2]']").keyup(function(key){
                var str=""+jQuery("input[name='freeattribut[2]']").val();
                str2=str.toUpperCase();
                str=str2;
                jQuery("input[name='freeattribut[2]']").val(str);
                if(cnt==0){
                    if(str.length<11){jQuery(".buy").prop('disabled', true);}
                    if(str.length>=11){
                        str2=str.substring(0, 11);
                        jQuery("input[name='freeattribut[2]']").val(str2);
                        jQuery(".buy").prop('disabled', false);
                    }
                }else{
                    if(cnt==-1){
                        if(str.length<11){jQuery(".buy").prop('disabled', true);}
                        ...
                        if(str.length<cnt){jQuery(".buy").prop('disabled', true);}
                        if(str.length>=cnt){
                            str2=str.substring(0, cnt);
                            jQuery("input[name='freeattribut[2]']").val(str2);
                            jQuery(".buy").prop('disabled', false);
                        }
                    }
            ...
            jQuery("input[name='freeattribut[2]']").keypress(function(key){
            if(((key.charCode >= 48 && key.charCode <= 57) || (key.charCode >= 65 && key.charCode <= 90)) || (key.charCode >= 97 && key.charCode <= 122)){
            }else{
                return false;
            }
            });
            
            jQuery("input[name='freeattribut[3]']").keyup(function(key){
                var str=""+jQuery("input[name='freeattribut[3]']").val();
                str2=str.toUpperCase();
                str=str2;
                jQuery("input[name='freeattribut[3]']").val(str);
                if(cnt==0){
                    if(str.length<15){jQuery(".buy").prop('disabled', true);}
                    if(str.length>=15){
                        str2=str.substring(0, 15);
                        jQuery("input[name='freeattribut[3]']").val(str2);
                        jQuery(".buy").prop('disabled', false);
                    }
                }else{
                    if(cnt==-1){
                        if(str.length<10){jQuery(".buy").prop('disabled', true);}
                      if(str.length>=10){
            ...
            jQuery("input[name='freeattribut[3]']").keypress(function(key){
            if(((key.charCode >= 48 && key.charCode <= 57) || (key.charCode >= 65 && key.charCode <= 90)) || (key.charCode >= 97 && key.charCode <= 122)){
            }else{
                return false;
            }
