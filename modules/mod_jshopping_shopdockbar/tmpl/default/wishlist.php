...
if (!count($wishlist->products)) return;
?>
<div id="carousel-wishlist" class="touchcarousel minimal-light">
	<ul class="touchcarousel-container">
		...
		<li class="touchcarousel-item">
			<div class="item-block">
				...
				<div class="item_name">
					<a href="<?php print $product_link?>"><?php print $product['product_name']?></a>
				</div>
			</div>
		</li>
		<?php } ?>
