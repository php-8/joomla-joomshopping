            ...
            for ($i=0; $i<count($files); $i++){
               ...
               if ($files[$i]->license > 0){  
                   ...
                   if ($files[$i]->license_url){
                       // add license link
                       $mail_files .= "<li><strong>".$files[$i]->file_title.' '.$files[$i]->release.'&nbsp;&nbsp;&nbsp;</strong>'.JText::_('COM_JDOWNLOADS_FE_DETAILS_LICENSE_TITLE').': <strong><a href="'.$files[$i]->license_url.'" target="_blank">'.$files[$i]->license_title.'</a></strong>&nbsp;&nbsp;&nbsp;'.JText::_('COM_JDOWNLOADS_FE_DETAILS_FILESIZE_TITLE').': <strong>'.$files[$i]->size.'</strong></li>';
                   } else {
                       $mail_files .= "<li><strong>".$files[$i]->file_title.' '.$files[$i]->release.'&nbsp;&nbsp;&nbsp;</strong>'.JText::_('COM_JDOWNLOADS_FE_DETAILS_LICENSE_TITLE').': <strong>'.$files[$i]->license_title.'&nbsp;&nbsp;&nbsp;</strong>'.JText::_('COM_JDOWNLOADS_FE_DETAILS_FILESIZE_TITLE').': <strong>'.$files[$i]->size.'</strong></li>';
                   }   
               } else {
                   $mail_files .= "<li><strong>".$files[$i]->file_title.' '.$files[$i]->release.'&nbsp;&nbsp;&nbsp;</strong>'.JText::_('COM_JDOWNLOADS_FE_DETAILS_FILESIZE_TITLE').': <strong>'.$files[$i]->size.'</strong></li>';
               }     
            }
