...
/* Hack for shipping/delivery */
 $payment_data_id = $cart->getShippingId();
if ( $payment_data_id == 32 ) {
    $cart->setShippingPrice($_POST['sh51']);
} elseif ($payment_data_id == 21) {
    $cart->setShippingPrice($_POST['sh50']);
} elseif ($payment_data_id == 3) {
    $cart->setShippingPrice('0');
} elseif ($payment_data_id == 15) {
    $cart->setShippingPrice($_POST['sh40']);
}  elseif ($payment_data_id == 20) {
    $cart->setShippingPrice($_POST['sh49']);
}  elseif ($payment_data_id == 34) {
    $cart->setShippingPrice($_POST['sh37']);
} elseif ($payment_data_id == 32) {
    $cart->setShippingPrice($_POST['sh51']);
} elseif ($payment_data_id == 16) {
    $cart->setShippingPrice($_POST['sh45']);
}elseif ($payment_data_id == 6) {
    $cart->setShippingPrice($_POST['sh43']);
}elseif ($payment_data_id == 5) {
    $cart->setShippingPrice($_POST['sh5']);
}else {
