...
$config->user_field_client_type = array(
    0=> defined('_JSHOP_REG_SELECT') ? _JSHOP_REG_SELECT : 'select',
    1=> defined('_JSHOP_PRIVAT_CLIENT') ? _JSHOP_PRIVAT_CLIENT : 'client',
    2=> defined('_JSHOP_FIRMA_CLIENT') ? _JSHOP_FIRMA_CLIENT : 'firma'
);

$config->user_field_title = array(
    0=> defined('_JSHOP_REG_SELECT') ? _JSHOP_REG_SELECT : 'select',
    1=> defined('_JSHOP_MR') ? _JSHOP_MR : 'mr',
    2=> defined('_JSHOP_MS') ? _JSHOP_MS : 'ms'
);
...
$config->sorting_products_name_select = array(
    1=> defined('_JSHOP_SORT_ALPH') ? _JSHOP_SORT_ALPH : 'alph',
    2=> defined('_JSHOP_SORT_PRICE') ? _JSHOP_SORT_PRICE : 'price',
    3=> defined('_JSHOP_SORT_DATE') ? _JSHOP_SORT_DATE : 'date',
    5=> defined('_JSHOP_SORT_RATING') ? _JSHOP_SORT_RATING : 'rating',
    6=> defined('_JSHOP_SORT_POPULAR') ? _JSHOP_SORT_POPULAR : 'popular',
    4=> defined('_JSHOP_SORT_MANUAL') ? _JSHOP_SORT_MANUAL : 'manual'
);
...
$config->count_product_select = array(
    ...
    '25' => 25,
    '50' => 50,
    '99999'=> defined('_JSHOP_ALL') ? _JSHOP_ALL : 'all'
);
