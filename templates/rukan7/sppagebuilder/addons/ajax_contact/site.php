...
function sp_ajax_contact_addon($atts){
	...
	$output .= '<div class="sppb-textarea sppb-form-group">';
	...
	$output .= '<div class="button-wrapper"><button type="submit" class="sppb-btn sppb-btn-default"><i class="fa"></i> '. JText::_('COM_SPPAGEBUILDER_ADDON_AJAX_CONTACT_SEND') .'</button> </div>';
