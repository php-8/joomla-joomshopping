...
<div class="jshop" id="comjshop_register">
    ...
    <div class = "jshop_register">
        ...
        <div class = "control-group">
          ...
          <div class = "controls">
            <input type = "text" name = "f_name" id = "f_name" value = "<?php print $this->user->f_name?>" class = "input" placeholder="<?php print _JSHOP_F_NAME ?>"/>
          </div>
        </div>
        <?php endif; ?>
        ...
        <div class = "control-group">
          ...
          <div class = "controls">
            <input type = "text" name = "l_name" id = "l_name" value = "<?php print $this->user->l_name?>" class = "input" placeholder="<?php print _JSHOP_L_NAME ?>" />
          </div>
        </div>
        <?php endif; ?>
        ...
        <div class = "control-group">
          ...
          <div class = "controls">
            <input type = "text" name = "m_name" id = "m_name" value = "<?php print $this->user->m_name?>" class = "input" placeholder="<?php print _JSHOP_M_NAME ?>"/>
          </div>
        </div>
        <?php endif; ?>
        ...
        <div class = "control-group">
          ...
          <div class = "controls">
            <input type = "text" name = "firma_name" id = "firma_name" value = "<?php print $this->user->firma_name?>" class = "input" placeholder="<?php print _JSHOP_FIRMA_NAME ?>"/>
          </div>
        </div>
        <?php endif; ?>
        ...
        <div class = "control-group" id = 'tr_field_firma_code' <?php if ($config_fields['client_type']['display']) : ?>style="display:none;"<?php endif; ?>>
          ...
          <div class = "controls">
            <input type = "text" name = "firma_code" id = "firma_code" value = "<?php print $this->user->firma_code?>" class = "input" placeholder="<?php print _JSHOP_FIRMA_CODE ?>"/>
          </div>
        </div>
        <?php endif; ?>
        ...
        <div class = "control-group" id = 'tr_field_tax_number' <?php if ($config_fields['client_type']['display']) : ?>style="display:none;"<?php endif; ?>>
          ...
          <div class = "controls">
            <input type = "text" name = "tax_number" id = "tax_number" value = "<?php print $this->user->tax_number?>" class = "input" placeholder="<?php print _JSHOP_VAT_NUMBER ?>"/>
          </div>
        </div>
        <?php endif; ?>
        ...
        <div class = "control-group">
          ...
          <div class = "controls">
            <input type = "text" name = "email" id = "email" value = "<?php print $this->user->email?>" class = "input" placeholder="<?php print _JSHOP_EMAIL ?>"/>
          </div>
        </div>
        <?php endif; ?>
        ...
        <div class = "control-group">
          ...
          <div class = "controls">
            <input type = "text" name = "email2" id = "email2" value = "<?php print $this->user->email2?>" class = "input" placeholder="<?php print _JSHOP_EMAIL2 ?>"/>
          </div>
        </div>
        <?php endif; ?>
    ...
    <div class = "jshop_register">
        ...
        <div class = "control-group">
          ...
          <div class = "controls">
            <input type = "text" name = "home" id = "home" value = "<?php print $this->user->home?>" class = "input" placeholder="<?php print _JSHOP_HOME ?>"/>
          </div>
        </div>
        <?php endif; ?>
        ...
        <div class = "control-group">
          ...
          <div class = "controls">
            <input type = "text" name = "apartment" id = "apartment" value = "<?php print $this->user->apartment?>" class = "input" placeholder="<?php print _JSHOP_APARTMENT ?>"/>
          </div>
        </div>
        <?php endif; ?>
        ...
        <div class = "control-group">
          ...
          <div class = "controls">
            <input type = "text" name = "street" id = "street" value = "<?php print $this->user->street?>" class = "input" placeholder="<?php print _JSHOP_STREET_NR ?>"/>
            <?php if ($config_fields['street_nr']['display']){?>
            <input type="text" name="street_nr" id="street_nr" value="<?php print $this->user->street_nr?>" class="input" placeholder="<?php print _JSHOP_STREET_NR ?>"/>
            <?php }?>
          </div>
        </div>
        <?php endif; ?>
        ...
        <div class = "control-group">
          ...
          <div class = "controls">
            <input type = "text" name = "zip" id = "zip" value = "<?php print $this->user->zip?>" class = "input" placeholder="<?php print _JSHOP_ZIP ?>"/>
          </div>
        </div>
        <?php endif; ?>
        ...
        <div class = "control-group">
          ...
          <div class = "controls">
            <input type = "text" name = "city" id = "city" value = "<?php print $this->user->city?>" class = "input" placeholder="<?php print _JSHOP_CITY ?>"/>
          </div>
        </div>
        <?php endif; ?>
        ...
        <div class = "control-group">
          ...
          <div class = "controls">
            <input type = "text" name = "state" id = "state" value = "<?php print $this->user->state?>" class = "input" placeholder="<?php print _JSHOP_STATE ?>"/>
          </div>
        </div>
        <?php endif; ?>
    ...
    <div class = "jshop_register">
        ...
        <div class = "control-group">
          ...
          <div class = "controls">
            <input type = "text" name = "phone" id = "phone" value = "<?php print $this->user->phone?>" class = "input" placeholder="<?php print _JSHOP_TELEFON ?>"/>
          </div>
        </div>
        <?php endif; ?>
        ...
        <div class = "control-group">
          ...
          <div class = "controls">
            <input type = "text" name = "mobil_phone" id = "mobil_phone" value = "<?php print $this->user->mobil_phone?>" class = "input" placeholder="<?php print _JSHOP_MOBIL_PHONE ?>"/>
          </div>
        </div>
        <?php endif; ?>
        ...
        <div class = "control-group">
          ...
          <div class = "controls">
            <input type = "text" name = "fax" id = "fax" value = "<?php print $this->user->fax?>" class = "input" placeholder="<?php print _JSHOP_FAX ?>"/>
          </div>
        </div>
        <?php endif; ?>
        ...
        <div class = "control-group">
          ...
          <div class = "controls">
            <input type = "text" name = "ext_field_1" id = "ext_field_1" value = "<?php print $this->user->ext_field_1?>" class = "input" placeholder="<?php print _JSHOP_EXT_FIELD_1 ?>"/>
          </div>
        </div>
        <?php endif; ?>
        ...
        <div class = "control-group">
          ...
          <div class = "controls">
            <input type = "text" name = "ext_field_2" id = "ext_field_2" value = "<?php print $this->user->ext_field_2?>" class = "input" placeholder="<?php print _JSHOP_EXT_FIELD_2 ?>"/>
          </div>
        </div>
        <?php endif; ?>
        ...
        <div class = "control-group">
          ...
          <div class = "controls">
            <input type = "text" name = "ext_field_3" id = "ext_field_3" value = "<?php print $this->user->ext_field_3?>" class = "input" placeholder="<?php print _JSHOP_EXT_FIELD_3 ?>"/>
          </div>
        </div>
        <?php endif; ?>
    </div>
    ...
    <div class = "jshop_register last_register_block">
        ...
        <div class = "control-group">
          ...
          <div class = "controls">
            <input type = "text" name = "u_name" id = "u_name" value = "<?php print $this->user->u_name?>" class = "input" placeholder="<?php print _JSHOP_USERNAME ?>"/>
          </div>
        </div>
        <?php endif; ?>
        ...
        <div class = "control-group">
          ...
          <div class = "controls">
            <input type = "password" name = "password" id = "password" value = "" class = "input" placeholder="<?php print _JSHOP_PASSWORD ?>"/>
          </div>
        </div>
        <?php endif; ?>
        ...
        <div class = "control-group">
          ...
          <div class = "controls">
            <input type = "password" name = "password_2" id = "password_2" value = "" class = "input" placeholder="<?php print _JSHOP_PASSWORD_2 ?>"/>
          </div>
        </div>
        <?php endif; ?>
        ...
        <div class = "control-group">
          ...
          <div class = "controls">
            <input type="checkbox" name="privacy_statement" id="privacy_statement" value="1" placeholder="<?php print _JSHOP_PRIVACY_STATEMENT ?>"/>
          </div>
        </div>
        <?php endif; ?>
    </div>
    ...
    <div class = "control-group box_button">
        <div class = "controls">
            ...
            <input type="submit" value = "<?php print _JSHOP_SEND_REGISTRATION ?>" class = "btn btn-primary button" placeholder="<?php print _JSHOP_REQUIRED ?>"/>
        </div>
    </div>
