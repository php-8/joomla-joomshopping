...
<div id="comjshop">
    ...
    <div class="jshop checkout_pfinish_block col-xs-12">
	<div class="mat_preview_finish">
        <?php print $this->_tmp_ext_html_previewfinish_start?>
        
        <div class="checkoutinfo">
            <div class="bill_address col-xs-12 col-md-3">
               <div> <h1><?php print _JSHOP_BILL_ADDRESS?></h1></div>
               <span>
            ...
            <?php if ($this->count_filed_delivery){?>
                <div class="delivery_address col-xs-12 col-md-3">
                   <div> <h1><?php print _JSHOP_FINISH_DELIVERY_ADRESS?></h1></div>
                   <span>
            ...
            <?php if (!$this->config->without_shipping){?>  
                <div class="shipping_info col-xs-12 col-md-3">
                    <div> <h1><?php print _JSHOP_FINISH_SHIPPING_METHOD?> </h1></div> 
            ...
            <?php if (!$this->config->without_payment){?>  
                <div class="payment_info col-xs-12 col-md-3">
                   <div> <h1><?php print _JSHOP_FINISH_PAYMENT_METHOD ?></h1></div> <span><?php print $this->payment_name ?></span>
                </div>
            <?php } ?>
        </div>
      </div>
        ...
        <form name = "form_finish" action = "<?php print $this->action ?>" method = "post" enctype="multipart/form-data">
            <div class="pfinish_comment_block">             
                ...
                <?php if ($this->config->display_agb){?>                 
                    <div class="row_agb mat_finish_checkout">            
                        <input type = "checkbox" name="agb" id="agb" class="checkbox" />        
