...
<div id="comjshop">
    ...
    <div class="jshop address_block">
        ...
        ?>
        <form action = "<?php print $this->action ?>" method = "post" name = "loginForm" onsubmit = "return validateCheckoutAdressForm('<?php print $this->live_path ?>', this.name)" class = "form-vertical" autocomplete="off" enctype="multipart/form-data">
