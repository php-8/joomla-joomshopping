...
require_once JPATH_ROOT . '/components/com_spsimpleportfolio/helpers/helper.php';
						...
						<div class="sp-vertical-middle">
							<div>
								<div class="sp-simpleportfolio-btns">
									<?php if( $this->item->video ) { ?>
										<a class="btn-zoom" href="#" data-featherlight="#sp-simpleportfolio-video<?php echo $this->item->spsimpleportfolio_item_id; ?>"><i class="icon-magnifier"></i></a>
									<?php } else { ?>
										<a class="btn-zoom" href="<?php echo JURI::base(true) . '/images/spsimpleportfolio/' . $this->item->alias . '/' . JFile::stripExt(JFile::getName($this->item->image)) . '_'. $rectangle .'.' . JFile::getExt($this->item->image); ?>" data-featherlight="image"><i class="icon-magnifier"></i></a>
									<?php } ?>
									<a class="btn-view" href="<?php echo $this->item->url; ?>"><i class="icon-link"></i></a>
								</div>
