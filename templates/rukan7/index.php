...
<head>
    ...
    <?php
    $this->helix3->addCSS('bootstrap.min.css, simple-line-icons.css, magnific.css, easyzoom.css, owl.carousel.css, owl.theme.css, shop.css, nice-select.css') // CSS Files
        ->addJS('bootstrap.min.js, jquery.sticky.js, jquery.magnific-popup.min.js, easyzoom.js, matblunic.js, functions.js, icheck.js, smoothscroll.js, jquery.elevateZoom-3.0.8.min.js, jquery.mmenu.min.all.js, jquery-ui.min.js, owl.carousel.min.js, jquery.nice-select.min.js') // JS Files
...
<body class="<?php echo $this->helix3->bodyClass( $body_classes ); ?>">
    <div class="body-innerwrapper">
        ...
        <div class="offcanvas-menu">
            <a href="#" class="close-offcanvas"><i class="">x</i></a>
