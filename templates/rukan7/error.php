...
$doc->addStylesheet( $this->baseurl . '/templates/' . $this->template . '/css/simple-line-icons.css' );
		...
		<div class="container error-page-inner">
			<div class="row">
				...
				<div class="error-details">	
					...
					<a class="btn btn-default btn-lg" href="<?php echo $this->baseurl; ?>/" title="<?php echo JText::_('HOME'); ?>"><i class="icon-arrow-left"></i> <?php echo JText::_('HELIX_GO_BACK'); ?></a>
